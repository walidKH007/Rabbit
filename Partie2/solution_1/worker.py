...
def clone_repo(git_url,repo_dir, client, image_name, commande):
    try:
        repo = Repo(repo_dir)
...
clone_repo(tache_json["git"],repo_workdir, client, image_name, tache_json["cmd"])
